...
health_fig = px.bar(
    ...
    width=1050,
    title=dict(
        text=f'{current_month} How Clients Feel About The Health Issue That Brought Them to BMHC',
        x=0.5, 
        font=dict(
            size=22,
            family='Calibri',
...
health_pie = px.pie(
    ...
    title=dict(
        x=0.5,
        text=f'{current_month} Ratio of How Clients Feel About The Health Issue That Brought Them to BMHC', 
        font=dict(
            size=22,  
            family='Calibri',  
            color='black'  
...
stress_fig = px.bar(
    ...
    width=1050,
    title=dict(
        text=f'{current_month} How Clients Feel About Their Stress Levels',
        x=0.5,
...
stress_pie = px.pie(
    ...
    title=dict(
        x=0.5,
        text=f'{current_month} Ratio of How Clients Feel About Their Stress Levels',
        font=dict(size=22, family='Calibri', color='black'),
    ),
    legend=dict(
        title='Rating',
...
mental_fig = px.bar(
    ...
    width=1050,
    title=dict(
        text=f'{current_month} How Clients are Feeling About Their Mental Well-being',
        x=0.5, 
        font=dict(
            size=22,
            family='Calibri',
...
mental_pie = px.pie(
    ...
    title=dict(
        x=0.5,
        text=f'{current_month} Ratio of How Clients are Feeling About Their Mental Well-being', 
        font=dict(
            size=22,  
            family='Calibri',  
            color='black'  
...
physical_fig = px.bar(
    ...
    width=1050,
    title=dict(
        text=f'{current_month} How Clients are Feeling About Their Physical Well-being',
        x=0.5, 
        font=dict(
            size=22,
            family='Calibri',
...
physical_pie = px.pie(
    ...
    title=dict(
        x=0.5,
        text=f'{current_month} Ratio of How Clients are Feeling About Their Physical Well-being', 
        font=dict(
            size=22,  
            family='Calibri',  
            color='black'  
...
expectation_fig = px.bar(
    ...
    width=1050,
    title=dict(
        text=f'{current_month} Did Medical Provider Meet Your Expectations?',
        x=0.5, 
        font=dict(
            size=22,
            family='Calibri',
...
expectation_pie = px.pie(
    ...
    title=dict(
        x=0.5,
        text=f'{current_month} Ratio of Provider Expectations Met?', 
        font=dict(
            size=22,  
            family='Calibri',  
            color='black'  
...
care_fig = px.bar(
    ...
    width=1050,
    title=dict(
        text=f'{current_month} Did Medical Care Meet Your Needs?',
        x=0.5,
        font=dict(
            size=22,
            family='Calibri',
...
care_pie = px.pie(
    ...
    title=dict(
        x=0.5,
        text=f'{current_month} Ratio of Care Needs Met?',
        font=dict(
            size=22,
            family='Calibri',
            color='black'
...
outreach_fig = px.bar(
    ...
    width=1050,
    title=dict(
        text=f'{current_month} Did Outreach Provide a Strong Support System?',
        x=0.5,
        font=dict(
            size=22,
            family='Calibri',
...
outreach_pie = px.pie(
    ...
    title=dict(
        x=0.5,
        text=f'{current_month} Ratio of Outreach Support Received?',
        font=dict(
            size=22,
            family='Calibri',
            color='black'
...
healthy_cuts_fig = px.bar(
    ...
    width=1050,
    title=dict(
        text=f'{current_month} Are You Interested in a Healthy Cuts Membership?',
        x=0.5, 
        font=dict(
            size=22,
            family='Calibri',
...
impression_fig = px.bar(
    ...
    width=1050,
    title=dict(
        text=f'{current_month} Overall Impression of BMHC?',
        x=0.5, 
        font=dict(
            size=22,
            family='Calibri',
...
impression_pie = px.pie(
    ...
    title=dict(
        x=0.5,
        text=f'{current_month} Ratio of Overall Impression of BMHC?', 
        font=dict(
            size=22,  
            family='Calibri',  
            color='black'  
